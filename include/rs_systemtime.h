...
struct Duration *duration_saturating_add(const struct Duration *self, struct Duration *dur);

struct Duration *duration_saturating_sub(const struct Duration *self, struct Duration *dur);

struct Duration *duration_saturating_mul(const struct Duration *self, uint32_t dur);

struct Duration *duration_checked_add(const struct Duration *self, struct Duration *dur);

struct Duration *duration_checked_sub(const struct Duration *self, struct Duration *dur);

struct Duration *duration_checked_mul(const struct Duration *self, uint32_t dur);
